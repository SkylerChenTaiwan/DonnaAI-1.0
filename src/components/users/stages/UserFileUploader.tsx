      ...
      <View style={styles.fileList}>
        {files.map((file) => (
          <View key={file.id} style={styles.fileItem}>
                    ...
                    {Platform.OS === 'web' ? (
                      <div
                        style={{
                          ...
                          paddingBottom: '8px',
                          borderRadius: '8px',
                          border: `1px solid ${!selectedKeyFields[file.id] && !file.keyField ? DesignSystem.colors.status.warning : DesignSystem.colors.border.light}`,
                          cursor: 'pointer' }}
                      ...
                      >
                        <span style={{
                          fontSize: '12px',
                          color: !selectedKeyFields[file.id] && !file.keyField ? DesignSystem.colors.status.warning : DesignSystem.colors.text.primary,
                          marginRight: '8px' }}>
            ...
            >
              <Icon name="close-circle" size={20} color={DesignSystem.colors.status.error} />
            </TouchableOpacity>
          </View>
        ))}
      </View>
        ...
        <View style={styles.mergeSection}>
          ...
          {!mergedTable && (
            <View style={styles.mergeWarning}>
              <Icon name="alert-circle-outline" size={16} color={DesignSystem.colors.status.warning} />
...
const styles = StyleSheet.create({
  ...
  mergeWarning: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: withAlpha(DesignSystem.colors.status.warning, 0.094),
